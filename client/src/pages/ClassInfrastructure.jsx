...
import NewClassroom from "../assets/NewClassroom.jpg";
import NewLab from "../assets/NewLab.jpg";
import SmartClass from "../assets/SmartClass.jfif";
import NewLibrary from "../assets/NewLibrary.jpg";
  ...
  const sections = [
    {
      ...
      images: [NewClassroom, NewClassroom],
    },
    {
      title: "Smart Classes",
      content: [
